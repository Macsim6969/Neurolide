import { allUsers, newUserData, setCardsPayment, setCardsTransaction, setMediaChannelsData, setOffersData, setUserData, updatedMonitoringData } from './../../store/actions/store.actions';
...
export class BackendService {
  ...
  public getFromActiveOffer() {
    return this.http.get<OfferInterface[]>(`https://neuroline-af6a2-default-rtdb.firebaseio.com/active-offers.json`).subscribe()
  }
  ...
  public getFromAddedOffer() {
    return this.http.get<OfferInterface[]>(`https://neuroline-af6a2-default-rtdb.firebaseio.com/added-offers.json`).subscribe()
  }
}
